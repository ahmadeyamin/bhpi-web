...
<div class="page-title d-flex justify-content-between">
    ...
    <div>
        <a href="{{ route('admin.notice.create') }}" class="btn btn-primary">New Notice</a>
    </div>
</div>
<div class="row mb-2">
    <div class="">
                ...
                <div class="table-responsive">
                    <table class="table table-light mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td class="text-bold-500">{{$notice->id}}</td>
                            <td>{{$notice->title}}</td>
                            <td class="text-bold-500">{{$notice->pined ? "Yes" : "No"}}</td>
                            <td><a href="{{asset(Storage::url($notice->url))}}" class="btn btn-link">Open</a></td>
