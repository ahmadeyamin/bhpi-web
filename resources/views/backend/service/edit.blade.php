...
<div class="row mb-2" x-data='{
    links: @json($service->links),
}'>
    <div class="">
        <div class="card">
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.service.update',$service->id) }}" class="card-body">
                @method("PUT")
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" value="{{ $service->sort }}" name="sort" id="sort" type="number" placeholder="sort"
                        data-sb-validations="required" />
                    <x-error name="sort"/>
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($service->image)
                    <img src="{{$service->image_url}}" class="my-3" width="100" />
                    @endif
            ...
            <form class="card-body" onsubmit="return confirm('Are you sure?')" action="{{ route('admin.service.destroy',$service->id) }}" method="post">
