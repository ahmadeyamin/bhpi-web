                ...
                <div class="notice-board-bg">
                    ...
                    <div id="notice-board-ticker">
                        <ul class="list list-unstyled">
                            <li class="clearfix">
                                <a href="#"
                                    title="এইচএসসি (ভোকেশনাল) উত্তীর্ণ শিক্ষার্থীদের ক্লাস্টারভিত্তিতে ০৪ (চার) বছর মেয়াদী ডিপ্লোমা ইন ইঞ্জিনিয়ারিং শিক্ষাক্রমে সরাসরি ৪র্থ পর্বের শুন্য আসনে ভর্তি বিজ্ঞপ্তি">
                                    <i class="text-green fa fa-arrow-circle-right"></i>
                                    <span>এইচএসসি (ভোকেশনাল) উত্তীর্ণ শিক্ষার্থীদের ক্লাস্টারভিত্তিতে ০৪
                                        (চার) বছর মেয়াদী ডিপ্লোমা ইন ইঞ্জিনিয়ারিং শিক্ষাক্রমে সরাসরি ৪র্থ
                                        পর্বের শুন্য আসনে ভর্তি বিজ্ঞপ্তি</span>
                                </a>
                            </li>
                            <li class="clearfix">
                                <a href="#"
                                    title="ভারত সরকারের Indian Technical and Economic Cooperation (ITEC) প্রোগ্রামের অধীনে বিভিন্ন কোর্সে প্রশিক্ষণার্থী মনোনয়ন প্রসঙ্গে">
                                    <i class="text-green fa fa-arrow-circle-right"></i>
                                    <span>ভারত সরকারের Indian Technical and Economic Cooperation (ITEC)
                                        প্রোগ্রামের অধীনে বিভিন্ন কোর্সে প্রশিক্ষণার্থী মনোনয়ন
                                        প্রসঙ্গে</span>
                                </a>
                            </li>
                            <li class="clearfix">
                                <a href="#l" title="যৌন হয়রানি কমিটি">
                                    <i class="text-green fa fa-arrow-circle-right"></i>
                                    <span>যৌন হয়রানি কমিটি</span>
                                </a>
                            </li>
                            <li class="clearfix">
                                <a href="#" title="ভারপ্রাপ্ত বিভাগীয় প্রধানের দায়িত্ব প্রদান সংক্রান্ত ।">
                                    <i class="text-green fa fa-arrow-circle-right"></i>
                                    <span>ভারপ্রাপ্ত বিভাগীয় প্রধানের দায়িত্ব প্রদান সংক্রান্ত ।</span>
                                </a>
                            </li>
                            <li class="clearfix">
                                <a href="#"
                                    title="‘সোলার এনার্জি ক্যালকুলেট ফর গ্রিন বাংলাদেশ’ শীর্ষক অনলাইন সেবাটি ব্যাপক প্রচার সংক্রান্ত">
                                    <i class="text-green fa fa-arrow-circle-right"></i>
                                    <span>‘সোলার এনার্জি ক্যালকুলেট ফর গ্রিন বাংলাদেশ’ শীর্ষক অনলাইন সেবাটি
                                        ব্যাপক প্রচার সংক্রান্ত</span>
                                </a>
                            </li>
                        </ul>
                        <div class="clearfix">
            ...
            <div id="news" class="section-title">
                ...
                <div class="news-container">
                    <div id="news-ticker" class="ticker">
                        <ul>
                            <li><a href="#"
                                    title="প্রিয় শিক্ষার্থী,  ক্লাসের জন্য একটি রুটিন দেওয়া হয়েছে।  ০৭ মে ২০২২ ইং তারিখ থেকে সকল পর্বের ক্লাস  চলমান । নিজ নিজ ক্লাস ক্যাপ্টেন/ক্লাস মনিটরের সাথে যোগাযোগ করে ক্লাস রুটিন সম্পর্কে জানার জন্য সংশ্লিষ্ট সকলে অনুরোধ করা হলো।">প্রিয়
                                    শিক্ষার্থী, ক্লাসের জন্য একটি রুটিন দেওয়া হয়েছে। ০৭ মে ২০২২ ইং তারিখ
                                    থেকে সকল পর্বের ক্লাস চলমান । নিজ নিজ ক্লাস ক্যাপ্টেন/ক্লাস মনিটরের সাথে
                                    যোগাযোগ করে ক্লাস রুটিন সম্পর্কে জানার জন্য সংশ্লিষ্ট সকলে অনুরোধ করা
                                    হলো।</a>
                            </li>

                            <li><a href="#" title="ই-নথির একাউন্টস সংক্রান্ত তথ্য সংগ্রহ">ই-নথির একাউন্টস
                                    সংক্রান্ত
                                    তথ্য সংগ্রহ</a>
                            </li>

                            <li><a href="#" title="প্লেসমেন্ট সেলের জন্য তথ্য সংগ্রহ চলছে">প্লেসমেন্ট সেলের
                                    জন্য
                                    তথ্য সংগ্রহ চলছে</a>
                            </li>
                        </ul>
